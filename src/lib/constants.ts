...
export const USERS = [
  ...
  {
    name: "Paul",
    message: "Cypress has streamlined our testing process and brought our teams closer. We're more efficient and deliver better results.",
  },
  {
    name: "Quinn",
    message:
  ...
  {
    name: "Rachel",
    message: "Thanks to Cypress, our testing process is now a seamless part of our development cycle. Our teams collaborate effortlessly.",
  },
  {
    name: "Sam",
    message:
